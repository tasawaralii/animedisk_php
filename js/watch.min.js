!(function (b) {
  (function () {
    ...
    var i,
      ...
      d = T.mobileDetectRules;
    for (i in d.props)
      if (u.call(d.props, i)) {
        for (r = d.props[i], c = (r = S(r) ? r : [r]).length, s = 0; s < c; ++s)
          0 <= (l = (a = r[s]).indexOf("[VER]")) &&
            (a = a.substring(0, l) + "([\\w._\\+]+)" + a.substring(l + 5)),
            (r[s] = new RegExp(a, "i"));
        d.props[i] = r;
      }
    return (
      ...
      (T.findMatch = function (e, t) {
        for (var n in e) if (u.call(e, n) && e[n].test(t)) return n;
        return null;
      }),
      (T.findMatches = function (e, t) {
        var n,
          i = [];
        for (n in e) u.call(e, n) && e[n].test(t) && i.push(n);
        return i;
      }),
      (T.getVersionStr = function (e, t) {
        var n,
          i,
          o,
          r,
          a = T.mobileDetectRules.props;
        if (u.call(a, e))
          for (o = (n = a[e]).length, i = 0; i < o; ++i)
            if (null !== (r = n[i].exec(t))) return r[1];
        return null;
      }),
      (T.getVersion = function (e, t) {
        e = T.getVersionStr(e, t);
        return e ? T.prepareVersionNo(e) : NaN;
      }),
      (T.prepareVersionNo = function (e) {
        var t = e.split(/[a-z._ \/\-]/i);
        return (
          1 === t.length && (e = t[0]),
          1 < t.length && ((e = t[0] + "."), t.shift(), (e += t.join(""))),
          Number(e)
        );
      }),
      ...
      (T.prepareDetectionCache = function (e, t, n) {
        var i;
        if (e.mobile === b)
          return (i = T.findMatch(T.mobileDetectRules.tablets, t))
            ? ((e.mobile = e.tablet = i), void (e.phone = null))
            : (i = T.findMatch(T.mobileDetectRules.phones, t))
            ? ((e.mobile = e.phone = i), void (e.tablet = null))
            : void (T.isMobileFallback(t)
                ? (i = o.isPhoneSized(n)) === b
                  ...
                  : ((e.mobile = e.tablet = T.FALLBACK_TABLET),
                    (e.phone = null))
                : T.isTabletFallback(t)
                ? ((e.mobile = e.tablet = T.FALLBACK_TABLET), (e.phone = null))
                : (e.mobile = e.tablet = e.phone = null));
      }),
      (T.mobileGrade = function (e) {
        var t = null !== e.mobile();
        return (e.os("iOS") && 4.3 <= e.version("iPad")) ||
          (e.os("iOS") && 3.1 <= e.version("iPhone")) ||
          (e.os("iOS") && 3.1 <= e.version("iPod")) ||
          (2.1 < e.version("Android") && e.is("Webkit")) ||
          7 <= e.version("Windows Phone OS") ||
          (e.is("BlackBerry") && 6 <= e.version("BlackBerry")) ||
          e.match("Playbook.*Tablet") ||
          (1.4 <= e.version("webOS") && e.match("Palm|Pre|Pixi")) ||
          e.match("hp.*TouchPad") ||
          (e.is("Firefox") && 12 <= e.version("Firefox")) ||
          (e.is("Chrome") && e.is("AndroidOS") && 4 <= e.version("Android")) ||
          (e.is("Skyfire") &&
            4.1 <= e.version("Skyfire") &&
            e.is("AndroidOS") &&
            2.3 <= e.version("Android")) ||
          (e.is("Opera") &&
            11 < e.version("Opera Mobi") &&
            e.is("AndroidOS")) ||
          e.is("MeeGoOS") ||
          e.is("Tizen") ||
          (e.is("Dolfin") && 2 <= e.version("Bada")) ||
          ((e.is("UC Browser") || e.is("Dolfin")) &&
            2.3 <= e.version("Android")) ||
          e.match("Kindle Fire") ||
          (e.is("Kindle") && 3 <= e.version("Kindle")) ||
          (e.is("AndroidOS") && e.is("NookTablet")) ||
          (11 <= e.version("Chrome") && !t) ||
          (5 <= e.version("Safari") && !t) ||
          (4 <= e.version("Firefox") && !t) ||
          (7 <= e.version("MSIE") && !t) ||
          (10 <= e.version("Opera") && !t)
          ? "A"
          : (e.os("iOS") && e.version("iPad") < 4.3) ||
            (e.os("iOS") && e.version("iPhone") < 3.1) ||
            (e.os("iOS") && e.version("iPod") < 3.1) ||
            (e.is("Blackberry") &&
              5 <= e.version("BlackBerry") &&
              e.version("BlackBerry") < 6) ||
            (5 <= e.version("Opera Mini") &&
              e.version("Opera Mini") <= 6.5 &&
              (2.3 <= e.version("Android") || e.is("iOS"))) ||
            e.match("NokiaN8|NokiaC7|N97.*Series60|Symbian/3") ||
            (11 <= e.version("Opera Mobi") && e.is("SymbianOS"))
          ? "B"
      ...
      (o.prototype = {
        ...
        os: function () {
          return (
            this._cache.os === b && (this._cache.os = T.detectOS(this.ua)),
            this._cache.os
          );
        },
        version: function (e) {
        ...
        is: function (e) {
          return (
            ...
            t(e, this.phone()) ||
            t(e, this.tablet()) ||
            n(T.findMatches(T.mobileDetectRules.utils, this.ua), e)
          );
        },
        match: function (e) {
          return (e = e instanceof RegExp ? e : new RegExp(e, "i")).test(
            this.ua
          );
        },
      ...
      "undefined" != typeof window && window.screen
        ? (o.isPhoneSized = function (e) {
            return e < 0 ? b : T.getDeviceSmallerSide() <= e;
          })
  ...
  !(function (e) {
    ...
    "Promise" in n
      ? n.Promise.prototype.finally || (n.Promise.prototype.finally = e)
      : (n.Promise = r);
  }),
  !(function (e, t) {
      ...
      (n = [
        function (e, t, n) {
          ...
          !function (e) {
            (t.c = function () {
              ...
              (t.d = function (e, t, n) {
                e = o.a[e];
                return void 0 !== e && Object(i.compare)(e, t, n);
              }),
              (t.a = function () {
        ...
        function (e, t, n) {
          ...
          var i,
            ...
            n = Object(n.a)(),
            o =
              "InstallTrigger" in ((null == n ? void 0 : n.window) || {}) ||
              /firefox/i.test(t.b),
            r = /trident/i.test(t.b) || /msie/i.test(t.b),
            a = /edge/i.test(t.b),
            s = /webkit/i.test(t.b) && !a,
            c = /IqiyiApp/.test(t.b),
            l =
              void 0 !==
                (null == (i = null == n ? void 0 : n.window)
                  ? void 0
                  : i.chrome) ||
              /chrome/i.test(t.b) ||
              /CriOS/i.test(t.b),
        ...
        function (e, t, n) {
          ...
          (t.a = function () {
            ...
            return null != i && i.document
              ? (e = i.document).createElement.apply(e, t)
              : {};
          }),
            n.d(t, "b", function () {
              return o;
          ...
          var t = n(0),
            i = Object(t.a)(),
            o =
              (null == (n = null == i ? void 0 : i.navigator)
                ? void 0
                : n.userAgent) || "xxxxx";
        },
        function (e, t, n) {
        ...
        function (e, t, n) {
          ...
          var t = n(3),
            i = /macintosh/i.test(t.b),
            o = /ipad/i.test(t.b) || (i && 1 < navigator.maxTouchPoints),
            r = /iphone/i.test(t.b),
            a = /android/i.test(t.b),
            s = /windows/i.test(t.b);
        },
        function (e, t, n) {
          "use strict";
          n.d(t, "a", function () {
          ...
          var i =
            ...
            o =
              ...
              (r.prototype.isLaunch = function () {
                return !this._detectLoopStopped;
              }),
              (r.prototype.setDetectDelay = function (e) {
              ...
              (r.prototype._detectLoop = function () {
              ...
              }),
              {
                ...
                isOpen: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return (
                        (l = !1), Object(o.c)({ dep: c }), Object(o.a)(), [2, l]
                      );
                    });
                  });
                },
                isEnable: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return [
                        2,
                        Object(r.b)({ includes: [!0], excludes: [i.c, i.d] }),
                      ];
                    });
                  });
                },
              ...
              typeof (i = function () {
                ...
                function u(e) {
                  var t = e.replace(/^v/, "").replace(/\+.*$/, ""),
                    ...
                    i = t.substring(0, n).split(".");
                  return i.push(t.substring(n + 1)), i;
                }
                function S(e) {
                ...
                function o(e, t) {
                  ...
                  for (
                    var n = u(e), i = u(t), o = 0;
                    o < Math.max(n.length - 1, i.length - 1);
                    o++
                  ) {
                    var r = parseInt(n[o] || 0, 10),
                      a = parseInt(i[o] || 0, 10);
                    if (r > a) return 1;
                    if (a > r) return -1;
                  }
                  ...
                  if (s && c) {
                    var l = s.split(".").map(S),
                      T = c.split(".").map(S);
                    for (o = 0; o < Math.max(l.length, T.length); o++) {
                      if (
                        void 0 === l[o] ||
                        ("string" == typeof T[o] && "number" == typeof l[o])
                      )
                        return -1;
                      if (
                        void 0 === T[o] ||
                        ("string" == typeof l[o] && "number" == typeof T[o])
                      )
                        return 1;
                      if (l[o] > T[o]) return 1;
                      if (T[o] > l[o]) return -1;
                ...
                return (
                  ...
                  (o.compare = function (e, t, n) {
                    !(function (e) {
                      ...
                      if (-1 === r.indexOf(e))
                        throw new TypeError(
                          "Invalid operator, expected one of " + r.join("|")
                        );
                    })(n);
                    var i = o(e, t);
            ...
            T =
              ...
              }),
              {
                ...
                isOpen: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return (l = !1), Object(o.b)(c), Object(o.a)(), [2, l];
                    });
                  });
                },
                isEnable: function () {
                ...
                isOpen: function () {
                  return s(this, void 0, void 0, function () {
                    return c(this, function (e) {
                      return (
                        (T = 0), Object(o.b)(l), Object(o.a)(), [2, 2 === T]
                      );
                    });
                  });
                },
            ...
            T =
              ...
              }),
              {
                ...
                isOpen: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return (l = !1), Object(i.b)(c), Object(i.a)(), [2, l];
                    });
                  });
                },
                isEnable: function () {
                  return a(this, void 0, void 0, function () {
                    return s(this, function (e) {
                      return [
                        2,
                        Object(r.b)({ includes: [!0], excludes: [o.g] }),
                      ];
                    });
                  });
                },
                  ...
                  return s(this, void 0, void 0, function () {
                    return c(this, function (e) {
                      return [
                        ...
                        Object(r.b)({
                          includes: [i.a],
                          excludes: [(a.isIpad || a.isIphone) && i.a],
                        }),
                      ];
                    });
                  });
          ...
          var i = n(1),
            ...
            T = {
              ...
              isEnable: function () {
                return a(this, void 0, void 0, function () {
                  return s(this, function (e) {
                    return [2, Object(r.b)({ includes: [i.a], excludes: [] })];
                  });
                });
              },
            };
...
md.match("playstation|xbox|smart-tv|smarttv") ||
  null !== md.mobile() ||
...
function getCommentWidgetMovie(e, t = !1) {
  var n = `/ajax/comment/widget/${movieId}?episodeId=${epId}&sort=` + cmSort,
    i =
      (currentUrl.search &&
        firstLoad &&
        (i = new URLSearchParams(currentUrl.search)).get("c_id") &&
        i.get("c_type") &&
        ((e = i.get("c_type")), (n = n + "&cId=" + i.get("c_id")), (t = !0)),
      (n = n + "&type=" + e),
      isInViewport(document.getElementById("content-comments")));
  i || t
    ? commentLoading ||
      ((commentLoading = !0),
      $.get(n, function (e) {
        var t;
        (commentLoaded = !(commentLoading = !1)),
...
$(document).on("click", "#cm-view-more", function () {
  if (!commentLoading) {
    ...
    var e = $(this).data("page"),
      ...
      e =
        `/ajax/comment/list/${movieId}?episodeId=${epId}&page=${e}&sort=${cmSort}&type=` +
        t;
    $.get(e, function (e) {
      (commentLoading = !1),
        e &&
          e.status &&
          (0 < e.nextPage ? n.data("page", e.nextPage) : n.remove(),
  ...
  $(document).on("click", ".cm-report", function () {
    ...
    checkLogin() &&
      ...
      (e = $(this).data("id")),
      (t = $(this).data("type")),
      $.post("/ajax/comment/report", { id: e, type: t }, function (e) {
        (commentLoading = !1),
          e.status
            ? toastr.success(e.msg, "", { timeOut: 6e3 })
            : toastr.error(e.msg, "", { timeOut: 6e3 });
      }));
  }),
  $(document).on("click", ".cm-cp-link", function () {
    ...
    navigator.clipboard.writeText(e),
      toastr.success("Link Copied.", "", { timeOut: 6e3 });
  }),
  ...
  $(document).on("click", ".cm-action", function () {
    const t = $(this).data("action"),
      n = $(this).data("id");
    $.post("/ajax/comment/update", { id: n, action: t }, function (e) {
      e.status
        ? ("hide" === t && $("#cm-" + n).remove(),
          toastr.success(e.msg, "", { timeOut: 6e3 }))
        : toastr.error(e.msg, "", { timeOut: 6e3 });
  ...
  $(document).on("click", ".ac-mute", function () {
    var e = $(this).data("hours"),
      t = $(this).parent().data("user-id");
    $.post("/ajax/user/mute", { user_id: t, hours: e }, function (e) {
      toastr.success(e.msg, "", { timeOut: 6e3 });
    });
  }),
  $(document).on("click", ".ac-block", function () {
    var e = $(this).data("user-id");
    $.post("/ajax/user/block", { user_id: e }, function (e) {
      toastr.success(e.msg, "", { timeOut: 6e3 });
    });
  }),
  $(document).on("click", ".cm-btn-vote", function () {
    ...
    checkLogin() &&
      ...
      ((commentLoading = !0),
      (e = $(this)),
      (t = parseInt(e.data("type"))),
      (n = e.data("id")),
      0 < (o = $(".cm-btn-vote[data-id=" + n + "].active")).length &&
        parseInt(o.data("type")) !== t &&
        (o.removeClass("active"),
        0 < (i = parseInt(o.find(".value").text()))) &&
        ((i -= 1), o.find(".value").text(0 < i ? i : "")),
      e.toggleClass("active"),
      (o =
        0 < (o = parseInt(e.find(".value").text()))
          ? e.hasClass("active")
            ? o + 1
            : o - 1
          : 1),
      e.find(".value").text(0 < o ? o : ""),
      $.post("/ajax/comment/vote", { id: n, type: t }, function (e) {
        (commentLoading = !1),
          e.status || toastr.error(e.msg, "", { timeOut: 6e3 });
      }));
  }),
  $(document).on("submit", ".comment-form", function (e) {
    if ((e.preventDefault(), !commentLoading)) {
      ...
      t.push({ name: "movie_id", value: movieId }),
        t.push({
          name: "is_spoil",
          value: $(".btn-spoil").hasClass("active") ? 1 : 0,
        }),
        grecaptcha
          .execute(recaptchaSiteKey, { action: "add_comment" })
          .then(function (e) {
            t.push({ name: "_token", value: e }),
              $.post("/ajax/comment/add", t, function (e) {
                var t, n;
                (commentLoading = !1),
                  o.hide(),
                  e && e.status
                    ? (0 < parseInt(e.parentId)
                        ? (0 < (t = $("#block-reply-" + e.parentId)).length
                            ? t.html(e.html)
                            : $("#cm-" + e.parentId).append(
                                `<div class="replies" id="block-reply-${e.parentId}">${e.html}</div>`
                              ),
                          $(`#cm-${e.parentId} .cm-btn-show-rep`).addClass(
                            "active"
                          ),
                      ...
                      i[0].reset(),
                      i.find(".btn-spoil").removeClass("active"))
                    : ((n = ""),
                      e.errors && 0 < e.errors.length
                        ...
                        : (n = e.msg),
                      i.find(".cm-error").html(n),
                      i.find(".cm-error").show(),
                      setTimeout(function () {
                        i.find(".cm-error").hide();
                      }, 1e4));
              });
          });
    }
...
var continueWatch = null,
  ...
  epNumber = null,
  firstLoad = !0,
  intervalContinueWatchLog = null;
const keyLsCurrentServer = "v2.6_currentServer";
...
function countViewMovie() {
  "watch" === page &&
    void 0 === Cookies.get("watched_" + movieId) &&
    setTimeout(function () {
      $.post("/ajax/movie/count-view/" + movieId, function (e) {
        Cookies.set("watched_" + movieId, !0, { path: "/", expires: 2 / 24 });
      });
    }, 6e4);
}
function nextEpisode() {
  var e, t;
  $(".ep-item.active").is(":last-child")
    ? ((e = (t = $(".ep-page-item.active").next()).data("page")),
      0 < t.length &&
        (t.click(),
        $("#episodes-page-" + e + " .ep-item")
          .first()
          .click()))
    : 0 < (t = $(".ep-item.active").next()).length && t.click();
}
function prevEpisode() {
  var e, t;
  $(".ep-item.active").is(":first-child")
    ? ((e = (t = $(".ep-page-item.active").prev()).data("page")),
      0 < t.length &&
        (t.click(),
        $("#episodes-page-" + e + " .ep-item")
          .last()
          .click()))
    : 0 < (t = $(".ep-item.active").prev()).length && t.click();
}
function continueWatchLog() {
  0 < playerCurrentTime &&
    playerCurrentTime !== playerPrevTime &&
    ((playerPrevTime = playerCurrentTime),
    $.post(
      "/ajax/continue-watch/log",
      {
        movie_id: movieId,
        episode_id: epId,
        episode_number: epNumber,
        time: Math.round(playerCurrentTime),
        percent: Math.round(playerCurrentPercent),
        duration: Math.round(playerDuration),
      },
      function (e) {}
    ));
}
function initContinueWatchingLog() {
  intervalContinueWatchLog && clearInterval(intervalContinueWatchLog),
    (intervalContinueWatchLog = setInterval(function () {
      isLoggedIn && checkedLogin
        ? continueWatchLog()
        : clearInterval(intervalContinueWatchLog);
    }, 1e4));
}
$(document).ready(function () {
  var e;
  0 < $(".schedule-alert").length &&
    ((e = new Date(
      $("#schedule-date").data("value").split(" ").join("T") + "Z"
    )),
    $("#schedule-date").text(e.toLocaleString("en-US"))),
    countViewMovie(),
    $.get("/ajax/v2/episode/list/" + movieId, function (e) {
      var t;
      e &&
        e.status &&
        ((continueWatch = e.continueWatch),
        1 < e.totalItems && ($(".block-prev").show(), $(".block-next").show()),
        $("#episodes-content").html(e.html),
        "en" !== userSettings.anime_name && toggleAnimeName("episode"),
        ("latest" === urlGetParamByName().w
          ? $(".ss-list").last().find(".ep-item").last()
          : 0 <
            (e = document.querySelectorAll(
              '.ep-item[data-id="' + urlGetParamByName().ep + '"]'
            )).length
          ? e[0]
          : continueWatch
          ? 0 <
            (e = document.querySelectorAll(
              '.ep-item[data-id="' + continueWatch.episode_id + '"]'
            )).length
            ? e[0]
            : $(".ss-list").first().find(".ep-item").first()
          : ((e = localStorageGet("watching." + movieId)),
            (t = document.querySelectorAll('.ep-item[data-id="' + e + '"]')),
            e && 0 < t.length
              ? t[0]
              : $(".ss-list").first().find(".ep-item").first())
        ).click(),
        0 < $(".ep-page-item").length
          ? $(
              ".ep-page-item[data-page=" +
                $(".ep-item.active").parent().data("page") +
                "]"
            ).click()
          : $(
              "#episodes-page-" + $(".ep-item.active").parent().data("page")
            ).show());
    }),
    $(".btn-comment-tab").click(function () {
      $(".btn-comment-tab").removeClass("active"), $(this).addClass("active");
    }),
    $(".btn-watch2gether").click(function (e) {
      e.preventDefault(),
        checkLogin() && (window.location.href = $(this).attr("href"));
    }),
    $(".dt-comment").click(function () {
      $(window).scrollTo("#comment-block", { duration: 300 });
    });
});
...
function getSources(e) {
  $("#source-guide").empty(),
    $.get("/ajax/v2/episode/sources?id=" + e, function (e) {
      var t;
      $("#embed-loading").hide(),
        e &&
          (e.htmlGuide &&
            ($("#content-guide").removeClass("only-one"),
            $("#source-guide").html(e.htmlGuide)),
          "" !== e.link) &&
          ((t = e.link),
          0 <= [1, 4].indexOf(parseInt(e.server)) &&
            ((t +=
              "&autoPlay=" +
              userSettings.auto_play +
              "&oa=" +
              (userSettings.play_original_audio || 0) +
              "&asi=" +
              userSettings.auto_skip_intro),
            continueWatch) &&
            parseInt($(".ep-item.active").data("id")) ===
              continueWatch.episode_id &&
            (t += "&time=" + continueWatch.time),
          $("#iframe-embed").attr("src", t),
          $("#iframe-embed").show());
    });
}
eventer(messageEvent, function (e) {
  ...
  try {
    "megacloud" === (n = JSON.parse(n)).channel &&
      ("complete" === n.event &&
        1 === parseInt(userSettings.auto_next) &&
        nextEpisode(),
      "time" === n.event &&
        ((playerCurrentTime = n.time),
        (playerCurrentPercent = n.percent),
        (playerDuration = n.duration)),
      "error" === n.event) &&
      0 < (t = $(".server-item .btn.active").parent().next()).length &&
      ($(".server-item .btn").removeClass("active"),
      t.find(".btn").addClass("active"),
      getSources(t.data("id")));
  } catch (e) {}
}),
    ...
    $(window).scrollTo(0, { duration: 200 }),
      document
        ...
        .contentWindow.postMessage(
          JSON.stringify({ event: "seek", time: e }),
          "*"
        );
  }),
  ...
  $(document).on("click", ".ep-item", function (e) {
    e.preventDefault(),
      ...
      (epId = $(this).data("id")),
      (epNumber = $(this).data("number")),
      initContinueWatchingLog();
    var e = $(this).next(),
      t = JSON.parse($("#syncData").text().trim());
    (t.episode = $(this).data("number")),
      0 < e.length
        ? (t.next_episode_url = t.series_url + "?ep=" + e.data("id"))
        : (t.next_episode_url = ""),
      $("#syncData").text(JSON.stringify(t)),
      localStorageSet("watching." + movieId, epId),
      getCommentWidgetMovie("episode"),
      firstLoad && currentUrl.search
        ? ((firstLoad = !1),
          history.pushState(
            {},
            "",
        ...
        : history.pushState(
            {},
            "",
            window.location.origin + window.location.pathname + "?ep=" + epId
          ),
      $(".ep-item").removeClass("active"),
      $(this).addClass("active"),
      $("#cm-episode-number").text($(this).find(".ssli-order").text()),
      $("#servers-content").html(
        '<div class="loading-relative"><div class="loading"><div class="span1"></div><div class="span2"></div><div class="span3"></div></div></div>'
      ),
      $("#episode-guide").empty(),
      $("#iframe-embed").hide(),
      $("#iframe-embed").attr("src", ""),
      $("#embed-loading").show(),
      $.get("/ajax/v2/episode/servers?episodeId=" + epId, function (e) {
        var t, n;
        e &&
          ($("#servers-content").html(e.html),
          $("#content-guide").addClass("only-one"),
          $("#episode-guide").html(e.htmlGuide),
          $("#embed-loading").hide(),
          (e = localStorageGet("currentSource")),
          (e = (t = urlGetParamByName().source) ? t : e) &&
          0 < $(".servers-" + e).length
            ? ((t = localStorageGet(keyLsCurrentServer)),
              (n = $(
                ".servers-" + e + " .server-item[data-server-id=" + t + "]"
              )),
              (t && 0 < n.length
                ? n
                : $(".servers-" + e + " .server-item").first()
              ).click())
            : 1 === parseInt(userSettings.enable_dub) &&
              (0 < $(".servers-mixed").length || 0 < $(".servers-dub").length)
            ? 0 < $(".servers-mixed").length
              ? $(".servers-mixed .server-item").first().click()
              : 0 < $(".servers-dub").length &&
                $(".servers-dub .server-item").first().click()
            : (0 < $(".servers-sub").length
                ? $(".servers-sub .server-item")
                : $(".server-item")
              )
                .first()
                .click());
      }),
      (0 < $(".ss-list-min").length
        ? (console.log($(".ss-list.active")), $(".ss-list.active"))
        : $(".ss-list")
      ).scrollTo(`.ep-item[data-id=${epId}]`, { duration: 300 });
  }),
  $(document).on("click", ".server-item", function (e) {
    $("#iframe-embed").hide(),
      ...
      getSources($(this).data("id")),
      localStorageSet("currentSource", $(this).data("type")),
