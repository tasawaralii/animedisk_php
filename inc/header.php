<div id="header" class="<?php echo $page['header-class'] ?>">
    <div class="container">
        ...
        <div class="header-group">
            <div class="anw-group">
                <div class="zrg-title"><span class="top">Join now</span><span class="bottom"><?php echo $data['name'] ?> Group</span></div>
                <div class="zrg-list">
                    <div class="item"><a href="<?php echo $data['telegram'] ?>" target="_blank" class="zr-social-button tl-btn"><i class="fab fa-telegram-plane"></i></a>
                    </div>
                    </div>
                <div class="clearfix"></div>
            </div>
                    ...
                    <ul class="ulclear">
                        <li class="pmu-item pmu-item-home">
                            <a class="pmu-item-icon" href="/home" title="Home">
                                <img src="/public/pick-home.svg" data-toggle="tooltip" data-placement="right"
                                     title="Home">
                            </a>
                        </li>
