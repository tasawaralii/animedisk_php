    ...
    <div id="xmain-wrapper">
                ...
                <div class="mwt-content">
                    ...
                    <div id="xsearch" class="home-search">
                        ...
                        <div id="action-button">
                            <a href="/home" class="btn btn-lg btn-radius btn-primary">Watch anime <i class="fas fa-arrow-circle-right ml-4"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mw-body">
            <div class="container">
                ...
                <div class="mwb-2col">
                    <div class="mwb-left">
                        <h1 class="mw-heading"><?php echo $data['domain'] ?> - The best site to watch anime online for Free</h1>
                        ...
                        <p>Just like free online movie streaming sites, anime watching sites are not created equally,
                            some are better than the rest, so we've decided to build <?php echo $data['domain'] ?> to be one of the best free
                            anime in Hindi streaming site for all anime fans on the world.</p>
                        <h2>1/ What is <?php echo $data['domain'] ?>?</h2>
                        <p><?php echo $data['domain'] ?> is a free site to watch anime in Hindi and you can even download Hindi subbed or dubbed anime in
                            ultra HD quality without any registration or payment. By having only one ad (Link Shortner) per 24 hours in all kinds, we are
                        ...
                        <h2>3/ So what make <?php echo $data['domain'] ?> the best site to watch anime in Hindi free online?</h2>
                        <p>Before building <?php echo $data['domain'] ?>, we've checked many other free anime sites, and learnt from them. We
                            only keep the good things and remove all the bad things from all the competitors, to put it
                            in our <?php echo $data['name'] ?> website. Let's see how we're so confident about being the best site for anime
                            streaming:</p>
                        <ul>
                            <li><strong>Safety:</strong> We try our best to not having harmful ads on <?php echo $data['name'] ?>.
                            </li>
                            <li><strong>Content library:</strong> Our main focus is anime. You can find here popular,
                                ...
                                titles come with English subtitles or are dubbed in Hindi and other regional languages (Tamil-Telugu-Malayalam-Bengali-Marathi).
                            </li>
                            <li><strong>Quality/Resolution:</strong> All titles are in excellent resolution, the best
                                quality possible. <?php echo $data['domain'] ?> also has a quality setting function to make sure our users can
                            ...
                            <li><strong>Streaming experience:</strong> Compared to other anime streaming sites, the
                                loading speed at <?php echo $data['domain'] ?> is faster. Downloading is just as easy as streaming, you won't
                            ...
                            <li><strong>Updates:</strong> We updates new titles as well as fulfill the requests on a
                                daily basis so be warned, you will never run out of what to watch on <?php echo $data['name'] ?>.
                            </li>
                            ...
                            <li><strong>Device compatibility:</strong> <?php echo $data['name'] ?>works alright on both your mobile and
                        ...
                        <p>So if you're looking for a trustworthy and safe site for your Anime streaming, let's give
                            <?php echo $data['domain'] ?> a try. And if you like us, please help us to spread the words and do not forget to
                            bookmark our site.</p>
                        <p>Thank you!</p>
                        <p>&nbsp;</p>
                    </div>
