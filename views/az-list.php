...
$page = array(
    'title' => "Watch Animes Start with ".$alpha." Anime Hindi DUBBED Online",
    'description' => "Full list of the ".$alpha." Anime Online Free, with Hindi DUBBED. WATCH NOW",
                ...
                <section class="block_area block_area_category">
                    <div class="block_area-header block_area-header-tabs">
                        <div class="float-left bah-heading mr-4">
                            <h2 class="cat-heading">List of <?php echo $alpha ?> Anime</h2>
                        </div>
                        <div class="clearfix"></div>
                    </div>
...
?>
                            ...
                            <?php
                            $totalPages = ceil($animes['total'][0]['total'] / $limit);
